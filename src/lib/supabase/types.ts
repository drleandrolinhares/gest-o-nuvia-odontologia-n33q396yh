...
//   $function$
//
// FUNCTION registrar_execucao_rotina(uuid, uuid, date, numeric, integer, uuid)
//   CREATE OR REPLACE FUNCTION public.registrar_execucao_rotina(p_rotina_id uuid, p_usuario_id uuid, p_data date, p_percentual numeric, p_pontos integer, p_marcado_por_id uuid DEFAULT NULL::uuid)
//    RETURNS void
//    LANGUAGE plpgsql
//    SECURITY DEFINER
//   AS $function$
