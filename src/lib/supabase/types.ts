  ...
  public: {
    Tables: {
      ...
      bonificacoes_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "bonificacoes_config_cargo_id_fkey"
            columns: ["cargo_id"]
            isOneToOne: false
      ...
      bonificacoes_criterios: {
        ...
        Relationships: [
          {
            foreignKeyName: "bonificacoes_criterios_cargo_id_fkey"
            columns: ["cargo_id"]
            isOneToOne: false
            referencedRelation: "cargos"
            referencedColumns: ["id"]
      ...
      dentistas_avaliadores: {
        ...
        Relationships: [
          {
            foreignKeyName: "dentistas_avaliadores_usuario_id_profiles_fkey"
            columns: ["usuario_id"]
            isOneToOne: true
      ...
      kpi_company_goals: {
        Row: {
          ...
          conversion_target_percent: number
          created_at: string
          entry_target_percent: number
          id: string
          period: string
          sales_total_target: number
        }
        Insert: {
          average_ticket_target?: number
          conversion_target_percent?: number
      ...
      rotinas_execucao: {
        ...
        Relationships: [
          {
            foreignKeyName: "rotinas_execucao_marcado_por_id_fkey"
            columns: ["marcado_por_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      user_cargos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_cargos_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      registrar_execucao_rotina: {
        Args: {
          p_data: string
          p_marcado_por_id?: string
          p_percentual: number
          p_pontos: number
          p_rotina_id: string
...
//   created_at: timestamp with time zone (not null, default: now())
// Table: bonificacoes_config
//   id: uuid (not null, default: gen_random_uuid())
//   usuario_id: uuid (nullable)
//   cargo_id: uuid (nullable)
//   data_vencimento_pagamento: date (nullable)
//   created_at: timestamp with time zone (not null, default: now())
// Table: bonificacoes_criterios
//   id: uuid (not null, default: gen_random_uuid())
//   cargo_id: uuid (nullable)
...
// Table: kpis_dentistas_avaliadores
//   id: uuid (not null, default: gen_random_uuid())
//   user_id: uuid (not null)
//   created_at: timestamp with time zone (not null, default: now())
...
// Table: metas_comerciais_empresa
//   id: uuid (not null, default: gen_random_uuid())
...
//   created_at: timestamp with time zone (not null, default: now())
// Table: metas_comerciais_individual
//   id: uuid (not null, default: gen_random_uuid())
//   usuario_id: uuid (not null)
//   mes: integer (not null)
//   ano: integer (not null)
...
//   created_at: timestamp with time zone (not null, default: now())
//   marcado_por_id: uuid (nullable)
//   tipo_marcacao: text (nullable, default: 'colaborador'::text)
...
//   status: text (not null, default: 'ORÇAMENTO'::text)
//   created_at: timestamp with time zone (not null, default: now())
...
// Table: bonificacoes_config
//   FOREIGN KEY bonificacoes_config_cargo_id_fkey: FOREIGN KEY (cargo_id) REFERENCES cargos(id) ON DELETE CASCADE
//   PRIMARY KEY bonificacoes_config_pkey: PRIMARY KEY (id)
//   FOREIGN KEY bonificacoes_config_usuario_id_fkey: FOREIGN KEY (usuario_id) REFERENCES auth.users(id) ON DELETE CASCADE
// Table: bonificacoes_criterios
//   FOREIGN KEY bonificacoes_criterios_cargo_id_fkey: FOREIGN KEY (cargo_id) REFERENCES cargos(id) ON DELETE CASCADE
//   PRIMARY KEY bonificacoes_criterios_pkey: PRIMARY KEY (id)
// Table: bonus_settings
...
//   FOREIGN KEY dentistas_avaliadores_usuario_id_fkey: FOREIGN KEY (usuario_id) REFERENCES auth.users(id) ON DELETE CASCADE
//   UNIQUE dentistas_avaliadores_usuario_id_key: UNIQUE (usuario_id)
//   FOREIGN KEY dentistas_avaliadores_usuario_id_profiles_fkey: FOREIGN KEY (usuario_id) REFERENCES profiles(id) ON DELETE CASCADE
// Table: departamentos
...
// Table: kpi_company_goals
//   UNIQUE kpi_company_goals_period_key: UNIQUE (period)
//   PRIMARY KEY kpi_company_goals_pkey: PRIMARY KEY (id)
// Table: kpi_individual_goals
//   PRIMARY KEY kpi_individual_goals_pkey: PRIMARY KEY (id)
//   FOREIGN KEY kpi_individual_goals_user_id_fkey: FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
//   UNIQUE kpi_individual_goals_user_id_period_key: UNIQUE (user_id, period)
// Table: kpis
...
// Table: kpis_dentistas_avaliadores
//   PRIMARY KEY kpis_dentistas_avaliadores_pkey: PRIMARY KEY (id)
//   FOREIGN KEY kpis_dentistas_avaliadores_user_id_fkey: FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
//   UNIQUE kpis_dentistas_avaliadores_user_id_key: UNIQUE (user_id)
// Table: kpis_permissoes
...
// Table: metas_comerciais_empresa
//   UNIQUE metas_comerciais_empresa_mes_ano_key: UNIQUE (mes, ano)
//   PRIMARY KEY metas_comerciais_empresa_pkey: PRIMARY KEY (id)
// Table: metas_comerciais_individual
//   PRIMARY KEY metas_comerciais_individual_pkey: PRIMARY KEY (id)
//   FOREIGN KEY metas_comerciais_individual_usuario_id_fkey: FOREIGN KEY (usuario_id) REFERENCES auth.users(id) ON DELETE CASCADE
//   UNIQUE metas_comerciais_individual_usuario_id_mes_ano_key: UNIQUE (usuario_id, mes, ano)
// Table: monthly_readings
...
// Table: rotinas_execucao
//   FOREIGN KEY rotinas_execucao_marcado_por_id_fkey: FOREIGN KEY (marcado_por_id) REFERENCES profiles(id) ON DELETE SET NULL
...
// Table: user_cargos
//   FOREIGN KEY user_cargos_cargo_id_fkey: FOREIGN KEY (cargo_id) REFERENCES cargos(id) ON DELETE CASCADE
//   PRIMARY KEY user_cargos_pkey: PRIMARY KEY (id)
//   FOREIGN KEY user_cargos_user_id_fkey: FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE
// Table: user_roles
...
// Table: vendas
//   FOREIGN KEY vendas_crc_comercial_id_fkey: FOREIGN KEY (crc_comercial_id) REFERENCES auth.users(id) ON DELETE SET NULL
//   FOREIGN KEY vendas_dentista_id_fkey: FOREIGN KEY (dentista_id) REFERENCES auth.users(id) ON DELETE SET NULL
...
//     WITH CHECK: true
// Table: bonificacoes_config
//   Policy "Allow all authenticated users on bonificacoes_config" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: bonificacoes_criterios
//   Policy "Allow all authenticated users on bonificacoes_criterios" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: bonus_settings
//   Policy "Allow all authenticated users" (ALL, PERMISSIVE) roles={authenticated}
...
//     USING: true
//   Policy "Enable read access for all users" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: inventory_temporary_outflows
//   Policy "Allow all authenticated users" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     WITH CHECK: true
// Table: kpi_company_goals
//   Policy "kpi_company_goals_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: kpi_individual_goals
//   Policy "kpi_individual_goals_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: kpis
...
//     WITH CHECK: true
// Table: kpis_dentistas_avaliadores
//   Policy "Allow all authenticated users on kpis_dentistas_avaliadores" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: kpis_permissoes
...
//     WITH CHECK: true
// Table: metas_comerciais_empresa
//   Policy "metas_comerciais_empresa_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: metas_comerciais_individual
//   Policy "metas_comerciais_individual_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: monthly_readings
...
//     USING: (is_admin_user(auth.uid()) OR is_master_user(auth.uid()) OR (colaborador_id = auth.uid()) OR ((colaborador_id IS NULL) AND (cargo_id IN ( SELECT uc.cargo_id    FROM user_cargos uc   WHERE (uc.user_id = auth.uid())))))
// Table: rotinas_execucao
//   Policy "rotinas_execucao_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: ((usuario_id = auth.uid()) OR is_admin_user(auth.uid()) OR is_master_user(auth.uid()) OR (EXISTS ( SELECT 1    FROM user_cargos uc   WHERE ((uc.user_id = auth.uid()) AND ((uc.cargo)::text = 'CEO'::text)))))
//   Policy "rotinas_execucao_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: ((usuario_id = auth.uid()) OR is_admin_user(auth.uid()) OR is_master_user(auth.uid()) OR (EXISTS ( SELECT 1    FROM user_cargos uc   WHERE ((uc.user_id = auth.uid()) AND ((uc.cargo)::text = 'CEO'::text)))))
...
//     USING: ((usuario_id = auth.uid()) OR is_admin_user(auth.uid()) OR is_master_user(auth.uid()) OR (EXISTS ( SELECT 1    FROM user_cargos uc   WHERE ((uc.user_id = auth.uid()) AND ((uc.cargo)::text = 'CEO'::text)))))
// Table: rotinas_pontos
//   Policy "rotinas_pontos_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: ((usuario_id = auth.uid()) OR is_admin_user(auth.uid()) OR is_master_user(auth.uid()) OR (EXISTS ( SELECT 1    FROM user_cargos uc   WHERE ((uc.user_id = auth.uid()) AND ((uc.cargo)::text = 'CEO'::text)))))
...
//     WITH CHECK: true
// Table: user_cargos
//   Policy "Admin CRUD user_cargos" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (is_admin_user(auth.uid()) OR is_master_user(auth.uid()))
//     WITH CHECK: (is_admin_user(auth.uid()) OR is_master_user(auth.uid()))
//   Policy "Users view own user_cargos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (user_id = auth.uid())
// Table: user_roles
...
//     WITH CHECK: true
// Table: vendas
//   Policy "Allow all authenticated users on vendas" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: work_schedules
//   Policy "Allow all authenticated users" (ALL, PERMISSIVE) roles={authenticated}
...
//   $function$
//   
// FUNCTION registrar_execucao_rotina(uuid, uuid, date, numeric, integer, uuid, text)
//   CREATE OR REPLACE FUNCTION public.registrar_execucao_rotina(p_rotina_id uuid, p_usuario_id uuid, p_data date, p_percentual numeric, p_pontos integer, p_marcado_por_id uuid DEFAULT NULL::uuid, p_tipo_marcacao text DEFAULT 'colaborador'::text)
//    RETURNS void
//    LANGUAGE plpgsql
//    SECURITY DEFINER
//   AS $function$
...
//       INSERT INTO public.rotinas_execucao (rotina_id, usuario_id, data, concluido, timestamp_conclusao, marcado_por_id, tipo_marcacao)
//       VALUES (p_rotina_id, p_usuario_id, p_data, true, NOW(), p_marcado_por_id, p_tipo_marcacao)
//       ON CONFLICT (rotina_id, usuario_id, data)
//       DO UPDATE SET 
//           concluido = true, 
//           timestamp_conclusao = NOW(), 
//           marcado_por_id = p_marcado_por_id,
...
//   $function$
//   
// FUNCTION sync_user_cargos_to_profiles()
...
// Table: user_cargos
//   trg_sync_user_cargos_to_profiles: CREATE TRIGGER trg_sync_user_cargos_to_profiles AFTER INSERT OR DELETE OR UPDATE ON public.user_cargos FOR EACH ROW EXECUTE FUNCTION sync_user_cargos_to_profiles()
...
// Table: dentistas_avaliadores
//   CREATE UNIQUE INDEX dentistas_avaliadores_usuario_id_key ON public.dentistas_avaliadores USING btree (usuario_id)
// Table: departamentos
...
// Table: kpi_company_goals
//   CREATE UNIQUE INDEX kpi_company_goals_period_key ON public.kpi_company_goals USING btree (period)
// Table: kpi_individual_goals
//   CREATE UNIQUE INDEX kpi_individual_goals_user_id_period_key ON public.kpi_individual_goals USING btree (user_id, period)
// Table: kpis_dentistas_avaliadores
//   CREATE UNIQUE INDEX kpis_dentistas_avaliadores_user_id_key ON public.kpis_dentistas_avaliadores USING btree (user_id)
// Table: kpis_permissoes
...
// Table: metas_comerciais_empresa
//   CREATE UNIQUE INDEX metas_comerciais_empresa_mes_ano_key ON public.metas_comerciais_empresa USING btree (mes, ano)
// Table: metas_comerciais_individual
//   CREATE UNIQUE INDEX metas_comerciais_individual_usuario_id_mes_ano_key ON public.metas_comerciais_individual USING btree (usuario_id, mes, ano)
// Table: monthly_readings
