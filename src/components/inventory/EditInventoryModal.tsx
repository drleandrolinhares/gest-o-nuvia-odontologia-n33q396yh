...
export function EditInventoryModal({
  ...
  const { updateInventoryItemDetails, packageTypes, specialties, inventoryOptions } = useAppStore()
  ...
  useEffect(() => {
    if (item && open) {
      form.reset({
        ...
        entryDate: item.entryDate ? new Date(item.entryDate) : undefined,
