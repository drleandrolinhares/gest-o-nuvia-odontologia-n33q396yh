import { Lightbulb, ArrowLeft, Hammer } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { useNavigate } from 'react-router-dom'

export default function PerformanceInovacao() {
    ...
    <div className="space-y-6 animate-fade-in-up uppercase">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-nuvia-navy flex items-center gap-3">
          <Lightbulb className="h-8 w-8 text-amber-600" /> INOVAÇÃO IMPLEMENTADA
        </h1>
        <p className="text-muted-foreground mt-1 font-semibold">
          REGISTRO E ACOMPANHAMENTO DE NOVAS IDEIAS E MELHORIAS.
        </p>
      </div>
