import { BookOpen, ArrowLeft, Hammer } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { useNavigate } from 'react-router-dom'

export default function PerformanceLeitura() {
    ...
    <div className="space-y-6 animate-fade-in-up uppercase">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-nuvia-navy flex items-center gap-3">
          <BookOpen className="h-8 w-8 text-blue-600" /> LEITURA DO MÊS
        </h1>
        <p className="text-muted-foreground mt-1 font-semibold">
          ACOMPANHAMENTO DOS ESTUDOS E LEITURAS SUGERIDAS.
        </p>
      </div>
