...
export default function EscalaTrabalho() {
  return (
    <div className="space-y-6 animate-fade-in-up uppercase">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-nuvia-navy flex items-center gap-3">
          <CalendarDays className="h-8 w-8 text-primary" /> ESCALA DE TRABALHO
        </h1>
        <p className="text-muted-foreground mt-1 font-semibold">
          GESTÃO DE TURNOS, HORÁRIOS E AUSÊNCIAS DA EQUIPE.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center space-y-4 border-2 border-dashed rounded-xl bg-card/50">
        ...
        <p className="text-sm font-medium text-muted-foreground max-w-md">
          A ESCALA DE TRABALHO ESTÁ SENDO IMPLEMENTADA E EM BREVE ESTARÁ DISPONÍVEL NESTA SESSÃO.
        </p>
      </div>
    </div>
  )
